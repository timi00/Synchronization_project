...
- Пути к каталогам, интервал синхронизации и путь к файлу логирования задаются параметрами командной строки при запуске программы. Можно посмотреть -help.
...
- Исключительные ситуации обработаны. Входные аргументы валидируются. В случае неправильного указания или удаления каталога-источника, будет выдана ошибка. В случае отсутсвия каталога-реплики или файла логирования, они будут созданы. В случае удаления каталога-реплики во врем выполнения программы, он будет скопирован из каталога-источника.
